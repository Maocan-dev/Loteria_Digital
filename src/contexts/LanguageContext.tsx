...
const translations = {
  en: {
    ...
    "cartas.clickInstructions":
      "Select the card that came out from the deck, to put the bean on it",
  ...
  es: {
    ...
    "cartas.cleaned": "Tabla se ha limpiado",
    ...
    "cartas.clickInstructions":
      "Selecciona la carta que salio del mazo, para colocar el frijolito encima",
    ...
    "footer.copyright":
      "© 2025 Lotería Flip Fun. Todos los derechos reservados.",
  },
};
