...
const translations = {
  en: {
    ...
    'timer.delay.2': 'Card delay: Too fast 2 seconds',
    ...
    'timer.delay.7': 'Card delay: Kind of slow 7 seconds',
    'timer.delay.8': 'Card delay: Way Slow 8 seconds',
    'timer.fast': 'Fast',
    'timer.medium': 'Medium',
    'timer.slow': 'Slow',
    'sound.on': 'Sound On',
  ...
  es: {
    ...
    'timer.delay.2': 'Retraso: Wow, muy rapido 2 segundos',
    ...
    'timer.delay.7': 'Retraso: Algo lento 7 segundos',
    'timer.delay.8': 'Retraso: Muy lento 8 segundos',
    'timer.fast': 'Rápido',
    'timer.medium': 'Medio',
    'timer.slow': 'Lento',
